                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>View Ledger</h4></div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Name<span>:</span></label>
                                        <div class="col-lg-8">
                                             <div class="view"><h5> <?php echo $result->name; ?> </h5> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Alias Name<span>:</span></label>
                                        <div class="col-lg-8">
                                             <div class="view"><h5> <?php echo $result->alias_name; ?> </h5> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                             <div class="view"><h5> <?php echo $result->opening_balance; ?> </h5> </div>
                                       </div>
                                    </div>
                                </div> 
                            </div>
