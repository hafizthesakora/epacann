                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Edit User</h4></div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">User Name</label> 
                                        <div class="col-lg-4">
                                            <input type="text" name="user_name" class="form-control validate[required]" value="<?php echo $result->user_name; ?>" > 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <select class="form-control" name="user_type">
                                                <option><?php echo $result->user_type; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="password" name="password" class="form-control validate[required]" id="txtNewPassword" value="<?php echo $result->password; ?>" > 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Repeat</label> 
                                        <div class="col-lg-4">
                                            <input type="password" name="repeat" class="form-control validate[required]" id="txtConfirmPassword" value="<?php echo $result->repeat; ?>" > 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="days" class="form-control" value="<?php echo $result->days; ?>" > 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Login Reset</label> 
                                        <div class="col-lg-4">
                                            <select class="form-control" name="login_reset" value="<?php echo $result->login_reset; ?>" >
                                                <option><?php echo $result->login_reset; ?></option>
