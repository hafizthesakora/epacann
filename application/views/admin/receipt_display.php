                    ...
                    <div class="col-md-9" style="float:right">
                        <div class="button-style-2 invoice-button add-btn">
                            <a href="create_receipt">
                                <span class="trans-icons-2"></span>Create Receipt</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="transactions-table trans-margin table-striped table-bordered dataTable" id="example">
                                ...
                                <thead class="transactions-table-head">
                                    <tr>
                                        ...
                                        <th>Rcpt Date</th>
                                        <th>Loan No.</th>
                                        <th style="width: 21% !important;">Party Name</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">GHS <?php echo $result->add_less; ?></td>
                                           <td style="text-align: center">
                                               <a href="view_receipt?receipt_id=<?php echo $result->receipt_id; ?>" class="btn btn-tbl-edit btn-xs" data-toggle="tooltip" title="View"><i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a href="edit_receipt?receipt_id=<?php echo $result->receipt_id; ?>" class="btn btn-tbl-edit btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                                <a class="delete btn btn-tbl-delete btn-xs" href="<?php echo base_url(); ?>admin/delete_receipt/<?php echo $result->receipt_id; ?>" title="Delete" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-trash-o "></i></a>       
                                             </td>
                                        </tr>    
                                        <?php
                                        $i++;
