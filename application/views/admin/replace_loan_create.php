                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="text" name="sno" class="form-control"  value="<?php
                                            if (!empty($idresults->sno)) {
                                                echo $idresults->sno + 1;
                                            } else {
                                                $count = 0;
                                                echo $count + 1;
                                            }
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <select class="form-control chosen input-height validate[required]" name="bank_name">
                                                <option hidden disabled selected value>Select Bank...</option>  
                                                <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5"> 
                                            <div class="class input-group date">
                                                <input name="date" class="form-control validate[required] datepicker" data-date-format="dd-mm-yyyy"  value="<?php echo $date ?>" placeholder="Loan Date" type="text"  >                                                    </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="text" name="bank_loan_no" id="bank_loan_no" class="form-control validate[required]">       
                                        </div>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <table class="transactions-table trans-margin">
                                ...
                                <tbody>
                                    <tr> 
                                        ...
                                        <td><input name="ac_no[]" id="ac_no" class="description-input  ac_no" value=""  maxlength="255" type="text" id="products0EstimateproductDescription"></td>
                                        <td><input name="party_name[]" id="party_name" class="description-input party_name"   maxlength="255" type="text" id="products0EstimateproductDescription"></td>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" name="loan_amount" id="loan_amount" class="form-control validate[required]">       
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" name="other_amt" id="other_amt" class="form-control validate[required]">       
                                    </div>
                                </div> 
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="row">
                                            <div class="col-md-4 col-xs-4">  
                                                <input type="text" class="form-control validate[required]" name="interest_per"  id="interest_per" name="interest" >                                                            </div>
                                            <div class="col-md-8 col-xs-8"> 
                                                <input type="text" name="interest" id="interest" class="form-control validate[required]"  maxlength="255"  maxlength="4">                                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" name="bal_amt" id="bal_amt" class="form-control validate[required]">       
                                    </div>
                                </div> 
                            </div>
                        </div>
...
<!--<script>
    ...
    $(".add-moresec").append('<tr><td><input name="ac_no[]" id="ac_no" class="description-input validate[required] ac_no" value=""  maxlength="255" type="text" id="products0EstimateproductDescription"></td><td><input name="party_name[]" id="party_name" class="description-input validate[required] party_name"   maxlength="255" type="text" id="products0EstimateproductDescription"></td><td><input name="remark[]" id="remark" class="description-input remark"  maxlength="255" type="text" id="products0EstimateproductDescription"></td>');
    });
    $(document).on('click', '.remove', function () {
