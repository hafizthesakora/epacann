    ...
    <div class="page-header">
       ...
       <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="itemgroup_display">Item Group</a></li>
                            <li class="active">Item Group Creation</li>
                        </ul>
                    </div>
    </div>
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Add Item group</h4></div>
                            <div class="row">
                                <div class="col-md-6">
                                   <div class="form-group">
                                                    <label class="col-lg-4 control-label">Item Group<span>:</span></label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="item_group" placeholder="Enter Item Name" class="form-control validate[required]">
                                                    </div>
                                                </div>
