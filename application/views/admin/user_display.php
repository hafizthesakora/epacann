<div class="content-wrapper">
    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                <li><a href="index.html"><i class="icon-home2 position-left"></i>Features</a></li>
                <li class="active">User Display</li>
            </ul>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="float:right">
                        <div class="button-style-2 invoice-button add-btn"> 
                            <a href="user_create">  
                                <span class="trans-icons-2"></span>Create User</a>    
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    foreach ($results as $result) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="edit_user?user_id=<?php echo $result->user_id; ?>" class="btn btn-tbl-edit btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                                <a class="delete btn btn-tbl-delete btn-xs" href="<?php echo base_url(); ?>admin/delete_user/<?php echo $result->user_id; ?>" title="Delete" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-trash-o "></i></a>       
                                            </td>
                                        </tr>    
                                        <?php
                                        $i++;
