    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li><a href="deposit_display">Deposit</a></li>
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>View Deposit</h4></div>
<div class="row">
                                <div class="col-md-offset-1 col-md-5">
                                    <div class="form-group">
                                        <label class="col-lg-5 control-label">Loan No <span>:</span></label>                                                    
                                        <div class="col-lg-7"> <div class="view"><h5><?php echo $result->dep_no; ?></h5> </div>
                                           </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7"> <div class="view"><h5> <?php echo $result->dep_amount; ?> </h5> </div>
                                      </div>
                                        </div></div>
                                <div class="col-md-6">
                                    
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Interest (GHS
) <span>:</span></label>                                                    
