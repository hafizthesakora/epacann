                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Add Ledger</h4></div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Name<span>:</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" name="name" id="name" placeholder="Enter Name" id="name" class="form-control validate[required]">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Print Name<span>:</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" name="print_name" id="copy" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control chosen validate[required] input-height" name="under">
...
<!--                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="opening_balance" placeholder="" class="form-control validate[required]">
                                        </div>
...
<script>
    $('#name').change(function () {
        $.ajax({
            url: "<?php echo base_url('admin/check_ledger')?>",
            data: 'name=' + $(this).val(),
            dataType: "json",
