    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Edit Deposit Payment</li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
            ...
            <div class="panel-body">
                <fieldset>
                    ...
                    <div class="trans-table">
                        <div class="trans-table-head"><h4>Edit Deposit Payment</h4></div>
                                    ...
                                    <div class="panel panel-flat loan-panel">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" name="pymt_no" id="pymt_no" placeholder="" class="form-control validate[required]" value="<?php echo $result->pymt_no; ?>" >            
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="class input-group date">
                                                        <input name="pymt_date" id="pymt_date" class="form-control validate[required] " data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y',strtotime($result->pymt_date)); ?>" placeholder="Payment Date" type="text"  >                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="class input-group date">
                                                        <input name="int_paid_upto_date" id="int_paid_upto_date" class="form-control validate[required] " data-date-format="dd-mm-yyyy"  value="<?php echo date('d-m-Y',strtotime($result->int_paid_upto_date)); ?>" placeholder="Interest Paid Upto Date" type="text"  >                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Dep No</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="dep_no" id="dep_no" placeholder="" class="form-control validate[required]" value="<?php echo $result->pre_bal_int_amt; ?>">
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                <label class="col-lg-4 control-label">Party Name</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="party_name" id="party_name" placeholder="" class="form-control validate[required]" value="<?php echo $result->pre_bal_int_amt; ?>">
                                                </div>
                                            </div>
                                              <div class="form-group">
                                                <label class="col-lg-4 control-label">Total Deposit Amount</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="total_dep_amt" id="total_dep_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->pre_bal_int_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Dep Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="dep_amt" id="dep_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->pre_bal_int_amt; ?>">
                                                </div>
                                            </div>
                                           <div class="form-group">
                                                <label class="col-lg-4 control-label">Int Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="int_amt"  id="int_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->int_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Pre Bal Int Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="pre_bal_int_amt" id="pre_bal_int_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->pre_bal_int_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Paid Int Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="paid_int_amt"  id="paid_int_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->paid_int_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Add/Less (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="add_less" id="add_less" placeholder="" class="form-control validate[required]" value="<?php echo $result->add_less; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label"><strong>Total Amt (GHS )</strong></label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="total_amt" id="total_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->total_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Pay To</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="pay_to" id="pay_to" placeholder="" value="CASH" class="form-control validate[required]" value="<?php echo $result->pay_to; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <select name="ac_close" id="ac_close" class="form-control validate[required]">
                                                        <option  value="<?php echo $result->pre_bal_int_amt; ?>"><?php echo $result->ac_close; ?></option>
                                    ...
                                    <div class="panel panel-flat loan-panel">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="class input-group date">
                                                        <input name="dep_date" id="dep_date" class="form-control validate[required]" data-date-format="dd-mm-yyyy"  value="<?php echo date('d-m-Y',strtotime($result->dep_date)); ?>" placeholder="Receipt Date" type="text"  >                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Dep Amt (GHS )</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="class input-group date">
                                                        <input name="last_paid_date" id="last_paid_date" class="form-control validate[required]" data-date-format="dd-mm-yyyy"  value="<?php echo date('d-m-Y',strtotime($result->last_paid_date)); ?>" placeholder="Last Paid Date" type="text"  >                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Total Days</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="total_days" id="total_days" placeholder="" class="form-control validate[required]" value="<?php echo $result->total_days; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Int Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text"  id="int_amount" placeholder="" class="form-control validate[required]" value="<?php echo $result->int_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Paid Dep Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="paid_dep_amt" id="paid_dep_amt" placeholder="" class="form-control validate[required]" value="<?php echo $result->paid_dep_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Pre Bal Int Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text"  id="pre_bal_int_amount" placeholder="" class="form-control validate[required]" value="<?php echo $result->pre_bal_int_amt; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Bal Dep Amt (GHS )</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="bal_dep_amt" id="bal_dep_amt" placeholder="" class="form-control form-space validate[required]" value="<?php echo $result->bal_dep_amt; ?>">
                                                </div>
                                            </div>
