                        ...
                        <div class="panel-body">
                            <fieldset>
                                ...
                                <div class="trans-table">
                                    <div class="trans-table-head"><h4>Edit Reference</h4></div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Reference Name<span>:</span></label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="reference_name" placeholder="Enter Area Name" value="<?php echo $result->reference_name; ?>" class="form-control validate[required]">
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
