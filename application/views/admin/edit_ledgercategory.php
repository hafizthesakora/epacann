    ...
    <div class="page-header">
       ...
       <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Ledger Category Edit</li>
                        </ul>
                    </div>
    </div>
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Edit Ledger Category</h4></div>
                            <div class="row">
                                <div class="col-md-6">
                                   <div class="form-group">
                                                    <label class="col-lg-4 control-label">Category Name<span>:</span></label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="name" id="name" placeholder="" class="form-control" value="<?php echo $result->name ?>">
                                                    </div>
                                                </div>
