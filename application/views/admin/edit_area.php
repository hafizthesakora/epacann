                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Edit Area</h4></div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Area Name<span>:</span></label>
                                        <div class="col-lg-7">
                                            <input type="text" name="area_name" placeholder="Enter Area Name" value="<?php echo $result->area_name; ?>" class="form-control validate[required]">
                                        </div>
                                    </div>
                                    <!--<div class="form-group">
