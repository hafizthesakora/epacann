    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Bank Name Creation</li>
            </ul>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Add Area</h4></div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Bank Name<span>:</span></label>
                                        <div class="col-lg-7">
                                            <input type="text" name="bank_name" id="bank_name" placeholder="Enter Bank Name" class="form-control  validate[required]">
                                        </div>
                                    </div>
...
<script>
    $('#bank_name').change(function () {
        $.ajax({
            url: "<?php echo base_url('admin/check_bank_name')?>",
            data: 'bank_name=' + $(this).val(),
            dataType: "json",
