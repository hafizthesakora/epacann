            ...
            <div class="panel-body">
                <fieldset>
                    ...
                    <div class="trans-table">
                        <div class="trans-table-head"><h4>View Receipt</h4></div>
                                    ...
                                    <div class="panel-body">
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="class input-group date">
                                                        <div class="view"><h5><?php echo date('d-m-Y', strtotime($result->receipt_date)); ?></h5> </div>
                                                         </div>
                                            </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="class input-group date">
                                                        <div class="view"><h5><?php echo date('d-m-Y', strtotime($result->int_rcvd_upto_dt)); ?></h5> </div>
                                                    </div>
                                            </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <div class="view"><h5> <?php echo $result->adv_int_amt; ?> </h5> </div>
                                            </div>
                                            </div>
                                            <div class="form-group">
                                         ...
                                         <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">  
                                                    <div class="view"><h5> <?php echo $result->rcvd_adv_int; ?> </h5> </div>
                                        </div>
                                                </div>
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">Pre Bal Int Amt (GHS
