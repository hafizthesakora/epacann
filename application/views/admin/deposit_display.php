    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li>Deposit</li>
                <li class="active">Deposit Display</li>
            </ul>
        </div>
    </div>
                        ...
                        <table class="transactions-table trans-margin table-striped table-bordered dataTable" id="example">
                            ...
                            <thead class="transactions-table-head">
                                <tr>
                                    ...
                                    <th class="text-right">Interest ( GHS )</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                foreach ($results as $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="view_deposit?deposit_id=<?php echo $result->deposit_id; ?>" class="btn btn-tbl-edit btn-xs" data-toggle="tooltip" title="View"><i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                            <a href="edit_deposit?deposit_id=<?php echo $result->deposit_id; ?>" class="btn btn-tbl-edit btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a class="delete btn btn-tbl-delete btn-xs" href="<?php echo base_url(); ?>admin/delete_deposit/<?php echo $result->deposit_id; ?>" title="Delete" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-trash-o "></i></a>       
                                        </td>
                                    </tr>    
                                    <?php
                                    $i++;
