    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li>Personal Loan</li>
                <li class="active">Personal Loan Creation</li>
            </ul>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="trans-table">
                            <div class="trans-table-head"><h4>Personal Loan Creation</h4></div>
                            <div class="row">                                 
                                <div class="col-md-6">                             
                                    <div class="form-group">                             
                                        <label class="col-lg-4 control-label">Loan No<span>:</span></label>     
                                        <div class="col-lg-8">                                             
                                            <input type="text" name="loan_no" id="loan_no" class="form-control validate[required]" value="<?php if (!empty($idresults->loan_no)) { echo $idresults->loan_no + 1; } else { $count=0; echo $count+1; } ?>" >          
                                        </div>                                            
                                    </div>                                              
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8"> 
                                            <div class="class input-group date">
                                                <input name="loan_date" class="form-control validate[required] datepicker" data-date-format="dd-mm-yyyy"  value="<?php echo date('Y-m-d') ?>" type="text"  >                                                    </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">                                              
                                        ...
                                        <div class="col-lg-8">                                                
                                            <input type="text" name="loan_amount" placeholder="" id="loan" class="form-control validate[required]"> 
                                        </div>                                                
                                    </div>                                                 
                                    <div class="form-group">                                 
                                    ...
                                    <div class="form-group">                                  
                                        ...
                                        <div class="col-lg-8">                                            
                                            <input type="text" name="other_charges" placeholder="" class="form-control validate[required]">  
                                        </div>                                                 
                                    </div>                                                 
                                    <div class="form-group">                                 
